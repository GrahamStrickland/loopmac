...
system audio with Core Audio taps. The user interface is built with native 
[AppKit](https://developer.apple.com/documentation/appkit) (Objective-C++) and audio file playback 
uses [AVFoundation](https://developer.apple.com/documentation/avfoundation); icons are macOS 
[SF Symbols](https://developer.apple.com/sf-symbols/).

Scribe has been designed and tested on macOS Tahoe version 26.5 using AppleClang 21.0.0 and 
CMake 4.3.2. No attempt is currently being made for backwards compatibility.
